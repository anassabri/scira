    ...
    <div className="min-h-screen bg-background">
            ...
            <motion.div variants={item} className="text-center">
              <Link href="/" className="inline-flex items-center gap-3 font-be-vietnam-pro font-bold">
                <div className="relative w-14 h-14 rounded-full bg-background/90 shadow-sm flex items-center justify-center border">
                  <AISearchLogo className="size-8 opacity-90" />
                </div>
              </Link>
            </motion.div>
      ...
      <div className="py-16 px-4">
        <div className="container max-w-3xl mx-auto prose dark:prose-invert prose-neutral prose-headings:font-be-vietnam-pro prose-p:text-muted-foreground prose-a:text-foreground prose-a:no-underline hover:prose-a:text-foreground/80 prose-headings:tracking-tight">
          <p className="text-lg">
            Welcome to AI Search. These Terms of Service govern your use of our website and services. By using AI Search, you agree to these terms in full. If you disagree with any part of these terms, please do not use our service.
          </p>

          <h2>1. Acceptance of Terms</h2>
          <p>
            By accessing or using AI Search, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service. We reserve the right to modify these terms at any time, and such modifications shall be effective immediately upon posting. Your continued use of AI Search after any modifications indicates your acceptance of the modified terms.
          </p>

          <h2>2. Description of Service</h2>
          <p>
            AI Search is a minimalistic AI-powered search engine that helps users find information on the internet. Our service utilizes artificial intelligence to process search queries and provide relevant results and information.
          </p>
          <p>
          ...
          <p>You agree not to use AI Search to:</p>
          <ul>
          ...
          <p>While we strive to provide accurate and reliable information, AI Search:</p>
          <ul>
          ...
          <p>
            ...
            AI Search should not be used as the sole source for making important decisions, especially in professional,
            medical, legal, or financial contexts.
          </p>

          <h2>5. Intellectual Property</h2>
          <p>
            All content, features, and functionality of AI Search, including but not limited to text, graphics, logos,
            icons, images, audio clips, and software, are the property of AI Search or its licensors and are protected by
          ...
          <p>AI Search relies on third-party services to provide its functionality:</p>
          <ul>
          ...
          <p>
            By using AI Search, you acknowledge and agree that your data may be processed by these third-party services
          ...
          <p>
            AI Search offers both free and paid subscription plans. For detailed pricing information, visit our{' '}
          ...
          <ul>
            ...
            <li>
              <strong>AI Search Pro:</strong> $15/month subscription with unlimited searches and access to all AI models
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Important:</strong> AI Search does not store any payment card details, bank information, or other
          ...
          <h2>9. Privacy</h2>
          <p>
            Your use of AI Search is also governed by our{' '}
          ...
          <p>
            To the maximum extent permitted by law, AI Search shall not be liable for any indirect, incidental, special,
          ...
          <p>
            AI Search is provided &quot;as is&quot; and &quot;as available&quot; without any warranties of any kind,
          ...
          <p>
            We reserve the right to suspend or terminate your access to AI Search, with or without notice, for conduct
          ...
          <p>
            ...
            AI Search operates, without regard to its conflict of law provisions.
          </p>

          <h2>14. Contact Us</h2>
          <p>If you have any questions about these Terms of Service, please contact us at:</p>
          <p>
            <a href="mailto:zaid@aisearch.com" className="flex items-center gap-1">
              zaid@aisearch.com <ExternalLink className="h-4 w-4" />
            </a>
          </p>

          <div className="my-8 border-t pt-8">
            <p className="text-sm text-muted-foreground">
              By using AI Search, you agree to these Terms of Service and our{' '}
              <Link href="/privacy-policy" className="underline">
                Privacy Policy
              </Link>
              .
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-background border flex items-center justify-center">
                <AISearchLogo className="size-4 opacity-80" />
              </div>
              <div className="text-sm text-muted-foreground">
                © {new Date().getFullYear()} AI Search by Zaid Mukaddam
              </div>
            </div>
